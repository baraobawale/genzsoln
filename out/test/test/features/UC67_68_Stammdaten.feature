...
Scenario Outline: <TestCase><ExpectedResult>
    ...
    Then Verify error "Bitte korrigieren Sie die folgenden Punkte:" is displayed
    And Verify error messsages are displayed
             |messages|
    ...
    Examples: 
      | TestCase                              | ExpectedResult | UserID/Kontonummer | PIN/Password | House_number | PLZ  | Ort  | Land | Branche          |
      | stammdaten_error_blankmandatoryfields | Verify errors  |          880589404 |        12345 | null         | null | null | null | Bitte auswaehlen |
