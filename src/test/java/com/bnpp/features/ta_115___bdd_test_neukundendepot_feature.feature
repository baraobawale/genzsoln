...
#Executable - Neukunden Depot Anlegen
  ...
  Scenario Outline: <TestCase>
    ...
    And User enters "Geburtsort_1" in "Geburtsort1_PersönlicheAngaben"
    And User selects "Geburtsland_1" in "Geburtsland 1_Kontoinhaber1"
    ...
    And User selects "Erfahrungen_im_Bereich_Wertpapierhande_l" in "ErfahrungenImBereichWertpapierhandel_Kontoinhaber1"
    ...
    And User selects radiobutton "verheiratet_oder_leben_Sie_miteinander" in "verheiratet oder leben Sie miteinander_Kontoinhaber2"
    And User selects "Staatsangehoerigkeit_2" in "Staatsangehoerigkeit 2_Kontoinhaber2"
    And User selects radiobutton "Weitere_Staatsangehoerigkeit_USA_2" in "Weitere Staatsangehoerigkeit USA 2_Kontoinhaber2"
  ...
  Scenario Outline: <TestCase>
    ...
    And User selects "Geburtsland_1" in "Geburtsland 1_Kontoinhaber"
    ...
    And User selects "Staatsangehoerigkeit_2" in "Staatsangehoerigkeit 2_GesetzlicherVertreter1Page"
    And User selects radiobutton "Weitere_Staatsangehoerigkeit_USA_2" in "Weitere Staatsangehoerigkeit USA 2_GesetzlicherVertreter1Page"
    ...
    And User enters "Land_2" in "Land2_GesetzlicherVertreter1Page"
    ...
    And User clicks on "WeiterGesetzlicherVertreter1Page"
