Feature: UC28_29_30_Sparplan
  ...
  Scenario Outline: <TestCase>
    ...
    And User selects "Sparintervall" in "Sparintervall_SparplanAnlegen"
    And User selects "Immer_am" in "Immer_am_SparplanAnlegen"
    And User enters "Laufzeit_von" in "Laufzeit_von_SparplanAnlegen"
    And User enters "Sparrate" in "Sparrate_SparplanAnlegen"
    And User selects "Dynamik" in "Dynamik_SparplanAnlegen"
    And User selects "Zum_Date" in "Zum_Date_SparplanAnlegen"
    And User selects "Zum_Month" in "Zum_Month_SparplanAnlegen"
    ...
    And User selects "IBAN" in "IBAN_SparplanAnlegen"
  ...
  Scenario Outline: <TestCase>
    ...
    #And User selects checkbox "Risikoklasse" in "Hoehere_Risikoklasse"
    And User selects "Sparintervall" in "Sparintervall_SparplanAendern"
    And User selects "Immer_am" in "ImmerAm_SparplanAendern"
    And User enters "Laufzeit_von" in "Laufzeit_von_SparplanAendern"
    And User selects "Zum_Date" in "ZumDate_SparplanAendern"
    And User selects "Zum_Month" in "ZumMonth_SparplanAendern"
  ...
  Scenario Outline: <TestCase>
    ...
    And User selects "IBAN" in "IBAN_EinmalzahlungFuerSparplan"
