...
#Neukunden Tagesgeld Anlegen
  ...
  Scenario Outline: <TestCase> <ExpectedResult>
    ...
    And User selects radiobutton "Sind_Sie_miteinander_Lebenspartnerschaft_2" in "SindSieMiteinanderLebenspartnerschaft2_Kontoinhaber2"
  ...
  Scenario Outline: <TestCase> <ExpectedResult>
    ...
    And User selects radiobutton "Weitere_Staatsangehoerigkeit_USA_2" in "Weitere Staatsangehoerigkeit USA 2_GesetzlicherVertreter1"
    ...
    And User enters "Land_2" in "Land2_GesetzlicherVertreter1"
  ...
  Scenario Outline: <TestCase> <ExpectedResult>
    ...
    And User selects "Staatsangehoerigkeit_2" in "Staatsangehoerigkeit 2_GesetzlicherVertreter1"
    ...
    And User enters "EMail_3" in "EMail2_GesetzlicherVertreter2"
    And User enters "EMail_wiederholen_3" in "EMailWiederholen3_GesetzlicherVertreter2"
