...
Feature: UC42_43_44_NeukundenSparplan
  ...
  Scenario Outline: <TestCase>
    ...
    And Capture Vorgangsnummer,Message on KostenlosesWertpapierdepotEinzel
  ...
  Scenario Outline: <TestCase>
    ...
    And User enters "Geburtsort_1" in "Geburtsort1_PersnlicheAngaben"
    And User selects "Geburtsland_1" in "Geburtsland_1_Kontoinhaber1"
    ...
    And Capture Vorgangsnummer,Message on KostenlosesWertpapierdepotGemeinschafts
    And User clicks on "EroeffnungsunterlagenHerunterladen_KostenlosesWertpapierdepotGemeinschafts"
    Then Verify captured Vorgangsnummer,Message from KostenlosesWertpapierdepotGemeinschafts
    And Download PDF generated in New Tab
  ...
  Scenario Outline: <TestCase>
    ...
    And User selects radiobutton "Weitere_Staatsangehoerigkeit_USA_2" in "Weitere_Staatsangehoerigkeit_USA2_GesetzlicherVertreter1Page"
    ...
    And User enters "Geburtsdatum_TT_3" in "GeburtsdatumTT3__GesetzlicherVertreter2Page"
    And User enters "Geburtsdatum_MM_3" in "GeburtsdatumMM3__GesetzlicherVertreter2Page"
    And User enters "Geburtsdatum_JJ_3" in "GeburtsdatumJJ3__GesetzlicherVertreter2Page"
    And User enters "Geburtsort_3" in "Geburtsort3_GesetzlicherVertreter2Page"
    And User selects "Geburtsland_3" in "Geburtsland3_GesetzlicherVertreter2Page"
    And User selects "Familienstand_3" in "Familienstand3_GesetzlicherVertreter2Page"
    And User selects "Staatsangehoerigkeit_3" in "Staatsangehoerigkeit3_GesetzlicherVertreter2Page"
    And User selects radiobutton "Weitere_Staatsangehoerigkeit_USA_3" in "Weitere_StaatsangehoerigkeitUSA3_GesetzlicherVertreter2Page"
    And User selects radiobutton "USA_steuerpflichtig_3" in "USASteuerpflichtig3_GesetzlicherVertreter2Page"
    And User enters "Strasse_Hausnummer_3" in "StrasseHausnummer3_GesetzlicherVertreter2Page"
    ...
    Examples: 
      | TestCase                                 |
      | SparplanMinderjaehrigenkonto_2GV_Anlegen |
