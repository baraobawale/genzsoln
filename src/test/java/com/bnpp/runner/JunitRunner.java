...
@CucumberOptions(monochrome = true, features = "src/test/java/com/bnpp/features/", dryRun = false, glue = {
		"com/bnpp/steps/" }, tags = "@Report_test", plugin = { "json:target/cucumber.json" })
...
public class JunitRunner {
	...
	public static void teardown() throws InterruptedException, IOException {
		 ...
		 * ./module-report/module-report/module-report/bin/module-report
		 * \"target/cucumber.json\" \"" + fileName + "\"
		 * \"./module-report/module-report/module-report/custom_templates/templates.json\"");
		 * TimeUnit.SECONDS.sleep(5); // Runtime.getRuntime().exec("cp -r ./Reports_RTA/
		 * ./Reports"); Process p = Runtime.getRuntime().exec("cp -r ./Reports_" +
		 * fileName + "/ ./Reports"); TimeUnit.SECONDS.sleep(5);
		 **/
